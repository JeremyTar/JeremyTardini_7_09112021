...
var PostService = /** @class */ (function () {
    ...
    PostService.prototype.getAllpostByUser = function (id) {
    ...
    PostService.prototype.addLike = function (id, userId) {
        return this.http.put("http://localhost:3000/api/posts/" + id + "/like", { userId: userId });
    };
    PostService.prototype.addDislike = function (id, userId) {
        return this.http.put("http://localhost:3000/api/posts/" + id + "/dislike", { userId: userId });
    };
